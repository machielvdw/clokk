...
export function registerEntryTools(server: McpServer, repo: Repository): void {
    ...
    "log_entry",
    {
      ...
      inputSchema: {
        ...
        project: z
          .string()
          .optional()
          .describe("Project name or ID. Use list_projects to find available projects."),
        from: z.string().describe("Start time in ISO 8601 UTC format"),
        to: z
          .string()
          .optional()
          .describe("End time in ISO 8601 UTC format. Mutually exclusive with duration."),
        duration: z
          .number()
          .optional()
  ...
  server.registerTool(
    "list_entries",
    {
      ...
      inputSchema: {
        ...
        tags: z.array(z.string()).optional().describe("Filter by tags (entries matching any tag)"),
        ...
        running: z
          .boolean()
          .optional()
          .describe("Filter by running status (true = only running, false = only stopped)"),
    ...
    "edit_entry",
    {
      ...
      inputSchema: {
        ...
        project: z
          .string()
          .optional()
          .describe("New project name or ID. Use list_projects to find available projects."),
        from: z.string().optional().describe("New start time (ISO 8601 UTC)"),
  ...
  server.registerTool(
    ...
    async (input) => handleToolCall(() => deleteEntry(repo, input.id)),
  );
}
