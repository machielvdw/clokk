...
export function registerProjectTools(
  ...
  server.registerTool("create_project", {
    ...
    inputSchema: {
      ...
      client: z
        .string()
        .optional()
        .describe("Client name associated with this project"),
      rate: z.number().optional().describe("Hourly billing rate"),
      currency: z
        .string()
        .optional()
        .describe("Currency code for the rate (default: USD)"),
      color: z
        .string()
        .optional()
        .describe("Hex color code for display (e.g., #FF5733)"),
    },
  ...
  server.registerTool("list_projects", {
    ...
    handleToolCall(() =>
      listProjects(repo, { include_archived: input.archived }),
    ),
  );
  ...
  server.registerTool("edit_project", {
    ...
    inputSchema: {
      ...
      name: z
        .string()
        .optional()
        .describe("New project name (must be unique)"),
